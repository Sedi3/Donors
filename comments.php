...
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
                                ...
                                <li>
                                    <div class="menu-item"><a href="profiles.html" class="menu-anchor" data-menu="2">Profiles</a>
                                      <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
                                ...
                                <li>
                                    <div class="menu-item"><a href="blood donations.html" class=""  data-menu="3">Blood donations</a></div>
                                </li>
                                <li>
                                    <div class="menu-item"><a href="calendar.html" class="menu-anchor"  data-menu="4">Calendar</a>
                                  <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
                                ...
                                <li>
                                    <div class="menu-item"><a href="comments.html" class=""  data-menu="5">Comments</a></div>
   </li>
     <li>
         <div class="menu-item"><a href="need blood.html" class="menu-anchor"  data-menu="6">Need Blood</a>
     <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
                ...
                <div class="conteudo-box">
                    <div class="conteudo-boxInner">
                        ...
                        <div class="mainThree" width="60%" height="400px">
                            ...
                            <div class="con2">
                              <img src="pictures/choker.jpg" height=90px width="160px"><br>
                              <p class="para02">"I have been donating blood since i turned 18 years, so i can help people and its been a great journey doing this for people in need."
          </p>
                            </div>
                        
                            <div class="con2">
                              <img src="pictures/green.jpg" height=90px width="160px"><br>
                              <p class="para02">"I have been diagnosed with sickle cell anemia so every now and again i need blood transfusion so no amount of words can express how grateful i am for the people that selflessly donate their blood for people like me."</p>
                            </div>
                          </div>
