<!DOCTYPE html>
		...
		<link rel="icon" href="pictures/sanbs.png">	
...
<!-- my external CSS -->
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="image/redcross.jpg" width="50px" height="50px"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" id="Tabactive" aria-current="page" href="index.php">Where To Donate</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="page2.php">Book A Blood Drive</a>
        </li>
		 <li class="nav-item">
          <a class="nav-link" href="page3.php">Donors</a>
        </li>
		 <li class="nav-item">
          <a class="nav-link" href="page4.php">About Blood</a>
        </li>
        <!-- Remove the above -->
                ...
                <div class="menu-wrapper">
                    <div class="menu-slider">
                        <div class="menu">
                            <ul >
                                <li>
                                    <div class="menu-item"><a href="index.php" class="menu-anchor" data-menu="1">Home</a>
...
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
                                ...
                                <li>
                                    <div class="menu-item"><a href="profiles.php" class="menu-anchor" data-menu="2">Profiles</a>
                                      <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
                                ...
                                <li>
                                    <div class="menu-item"><a href="profiles.php" class=""  data-menu="3">Blood donations</a></div>
                                </li>
                                <li>
                                    <div class="menu-item"><a href="calendar.php" class="menu-anchor"  data-menu="4">Calendar</a>
                                  <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
                                ...
                                <li>
                                    <div class="menu-item"><a href="comments.php" class=""  data-menu="5">Comments</a></div>
   </li>
     <li>
         <div class="menu-item"><a href="need blood.php" class="menu-anchor"  data-menu="6">Need Blood</a>
     <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
	<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
...
<li>
    <div class="menu-item"><a href="index.php" class="menu-anchor" data-menu="1">log out</a>
      <svg class="spt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;" xml:space="preserve">
<g>
<path d="M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744   L278.318,225.92L106.409,54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284   c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
</g>
			...
			<h1>Social Donors</h1>
                <div class="conteudo-box">
                    <div class="conteudo-boxInner">
						...
						<br><br>
                        <center>
                            <img src="pictures/recycle.jpg" width="150px" height="100px" align="left">
                            <img src="pictures/black.jpg" width="150px" height="100px" align="left">
                            <img src="pictures/missing.png" width="150px" height="100px" align="left">
                            <img src="pictures/history.jpg" width="150px" height="100px" align="left">
                            </center>
                </div>
            </div>
        </div>
...
<div class="footerBottom1">
    <hr>
    <img class="footerIcons" src="pictures/face.png" width="30px" height="30px">
    <img class="footerIcons" src="pictures/twitter.png" width="30px" height="30px">
  </div>
</body>
</html>